...
object Ivory {
  ...
  type ExtractionConfig = com.ambiata.ivory.operation.extraction.ExtractionConfig
  val ExtractionConfig = com.ambiata.ivory.operation.extraction.ExtractionConfig
