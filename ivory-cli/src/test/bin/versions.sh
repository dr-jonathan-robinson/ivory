...
# Last version before v6 metadata where days_in expression was introduced
export IVORY_V8="1.0.0-cdh5-20150909040516-0030e64 2.11"

# The _first_ version that had the current metadata version - see 'dictionary-metadata' test
export IVORY_BASELINE="1.0.0-cdh5-20150914060033-edfc302 2.11"
